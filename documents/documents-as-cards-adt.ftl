...
<div class="row row-spacing">
	<#list entries as entry>
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 card-type-asset image-card" style="margin-right: 20px;">
	<div class="card">
			...
			<div class="card-row">
				<div class="autofit-col autofit-col-expand">
					...
					<div class="mt-3 text-center">
    					<button class="btn btn-outline-primary" data-target="#lexFullScreenModalIframe-${assetRenderer.getClassPK()}" data-toggle="modal">			
    								<span class="small">
